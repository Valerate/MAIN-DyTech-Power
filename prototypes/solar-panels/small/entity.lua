...
{
  {
    ...
    minable = {hardness = 0.2, mining_time = 0.5, result = "small-solar-panel"},
  ...
  {
    type = "solar-panel",
    name = "small-solar-panel-mk2",
    icon = "__MAIN-DyTech-Power__/graphics/solar-panels/small/icons/solar-panel2.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "small-solar-panel-mk2"},
  ...
  {
    type = "solar-panel",
    name = "small-solar-panel-mk3",
    icon = "__MAIN-DyTech-Power__/graphics/solar-panels/small/icons/solar-panel3.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "small-solar-panel-mk3"},
  ...
  {
    type = "solar-panel",
    name = "small-solar-panel-mk4",
    icon = "__MAIN-DyTech-Power__/graphics/solar-panels/small/icons/solar-panel4.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "small-solar-panel-mk4"},
    ...
    type = "solar-panel",
    name = "small-solar-panel-mk5",
    icon = "__MAIN-DyTech-Power__/graphics/solar-panels/small/icons/solar-panel5.png",
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "small-solar-panel-mk5"},
