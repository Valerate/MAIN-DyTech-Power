...
data.raw["accumulator"]["accumulator"].max_health = Health.Tier2
data.raw["accumulator"]["accumulator"].resistances = Resistances.Tier2
data.raw["accumulator"]["accumulator"].energy_source.buffer_capacity = Accumulators.Buffer.Normal.Tier1
data.raw["accumulator"]["accumulator"].energy_source.input_flow_limit = Accumulators.Input.Normal.Tier1
data.raw["accumulator"]["accumulator"].energy_source.output_flow_limit = Accumulators.Output.Normal.Tier1
...
data:extend(
{
  ...
  },
  {
    ...
    flags = {"placeable-neutral", "player-creation"},
    minable = {hardness = 0.2, mining_time = 0.5, result = "accumulator-mk6"},
